...
if ( isset( $_POST['submit'] ) ) {
    ...
    //create view
    $req3 = $bdd->prepare( 'select * from habitation where habitation.numH NOT IN (select numH from reservation ) AND id_cat = :id_cat AND idR = :idR ', array());
                ...
                <div class=\"bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center >';
                    while($result3 = $req3->fetch())
                    {
                        ...
                        echo ' <span>
                              ...
                              </span>    <hr align=center size=8 width="60%" color="black">
